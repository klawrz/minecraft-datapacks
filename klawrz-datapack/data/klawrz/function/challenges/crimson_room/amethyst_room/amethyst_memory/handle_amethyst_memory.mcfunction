# Detect bumps
execute as @e[tag=amethyst_skeleton,tag=!locked] at @s if entity @p[gamemode=!spectator,distance=..0.5] run function klawrz:challenges/crimson_room/amethyst_room/amethyst_memory/on_bump
