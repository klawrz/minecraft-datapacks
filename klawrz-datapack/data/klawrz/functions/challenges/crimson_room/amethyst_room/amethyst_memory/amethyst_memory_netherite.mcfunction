# Handle netherite head
#

# Prevent function from firing again / remember that card is flipped
tag @s add flipped

# Change head to netherite
data merge entity @s {ArmorItems: [{}, {}, {}, {id:"minecraft:netherite_block", Count: 1b}], HandItems: [{id:"minecraft:netherite_block", Count: 1b}, {id:"minecraft:netherite_block", Count: 1b}]}
