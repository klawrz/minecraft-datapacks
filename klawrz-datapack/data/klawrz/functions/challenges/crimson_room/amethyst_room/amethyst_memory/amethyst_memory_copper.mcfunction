# Handle waxed_copper head
#

# Prevent function from firing again / remember that card is flipped
tag @s add flipped

# Change head to waxed_copper
data merge entity @s {ArmorItems: [{}, {}, {}, {id:"minecraft:waxed_copper_block", Count: 1b}], HandItems: [{id:"minecraft:waxed_copper_block", Count: 1b}, {id:"minecraft:waxed_copper_block", Count: 1b}]}
