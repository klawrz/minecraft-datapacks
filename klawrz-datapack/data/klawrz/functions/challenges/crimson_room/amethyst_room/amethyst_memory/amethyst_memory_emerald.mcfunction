...
# Change head to emerald
data merge entity @s {ArmorItems: [{}, {}, {}, {id:"minecraft:emerald_block", Count: 1b}], HandItems: [{id:"minecraft:emerald_block", Count: 1b}, {id:"minecraft:emerald_block", Count: 1b}]}
