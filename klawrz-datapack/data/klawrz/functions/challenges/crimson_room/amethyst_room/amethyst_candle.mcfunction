...
setblock ~2 ~-1 ~ chest[type=left, facing=east]{Items: [{Slot: 22b, id: "minecraft:splash_potion", Count:1b, tag: {CrimsonRoomNeedsReset:1b, AmethystPotion: 1b, CustomPotionColor:1965844, display: {Name: '{"text":"Highly Corrosive Splash Potion","color":"red"}', Lore: ['{"text":"So corrosive it could melt right","color":"dark_gray"}', '{"text":"through iron bars. Throwable too!","color":"dark_gray"}']}}}]}
